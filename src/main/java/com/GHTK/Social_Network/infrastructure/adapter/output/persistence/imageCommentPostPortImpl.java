...
import com.GHTK.Social_Network.infrastructure.repository.ImageCommentRepository;
...
public class imageCommentPostPortImpl implements ImageCommentPostPort {
  ...
  @Override
  public ImageCommentEntity saveImageComment(ImageCommentEntity imageComment) {
