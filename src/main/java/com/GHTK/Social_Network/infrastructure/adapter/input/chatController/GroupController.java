...
public class GroupController {
  ...
  public ResponseEntity<Object> getMembersFromGroup(@PathVariable String groupId) {
    return ResponseHandler.generateResponse(ResponseHandler.MESSAGE_SUCCESS, HttpStatus.OK, groupPortInput.getMemberToGroup(groupId));
  }
  ...
  @GetMapping("/{groupId}")
  public ResponseEntity<Object> getMyGroup(@PathVariable String groupId) {
    return ResponseHandler.generateResponse(ResponseHandler.MESSAGE_SUCCESS, HttpStatus.OK, groupPortInput.getMyGroup(groupId));
  }
}