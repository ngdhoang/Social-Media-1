...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Object> handleHttpMediaTypeNotSupportedException(Exception  ex) {
    return ResponseHandler.generateErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
  }

  @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
  public ResponseEntity<Object> handleHttpRequestMethodNotSupportedException(Exception ex) {
    return ResponseHandler.generateErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST);
  }
